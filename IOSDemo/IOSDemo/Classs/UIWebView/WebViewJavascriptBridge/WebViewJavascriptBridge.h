...
//typedef void (^webTitleCallback)(NSString *strTitle);
...
@property (nonatomic, copy) void(^webTitleCallback)(NSString *);
@property (nonatomic, copy) void(^clickCallback)(NSURL *);
@property (nonatomic, copy) void(^webLoadErrorCallback)(NSString *);
